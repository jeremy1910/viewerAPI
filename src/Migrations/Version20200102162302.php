 ...
 */
final class Version20200102162302 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE profil_badge (profil_id INT NOT NULL, badge_id INT NOT NULL, INDEX IDX_B0FC9359275ED078 (profil_id), INDEX IDX_B0FC9359F7A2C2FC (badge_id), PRIMARY KEY(profil_id, badge_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE badge_profil (badge_id INT NOT NULL, profil_id INT NOT NULL, INDEX IDX_D46A11D2F7A2C2FC (badge_id), INDEX IDX_D46A11D2275ED078 (profil_id), PRIMARY KEY(badge_id, profil_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
