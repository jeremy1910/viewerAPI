 ...
 */
final class Version20191022160445 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__installation AS SELECT id, name FROM installation');
        $this->addSql('DROP TABLE installation');
        $this->addSql('CREATE TABLE installation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO installation (id, name) SELECT id, name FROM __temp__installation');
        $this->addSql('DROP TABLE __temp__installation');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_360FA570B839C441 ON glecteur_variable (glecteur_id)');
        $this->addSql('CREATE INDEX IDX_360FA570F3037E8E ON glecteur_variable (variable_id)');
        $this->addSql('ALTER TABLE installation ADD COLUMN path VARCHAR(255) NOT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX IDX_E6D6B297167B88B4');
        $this->addSql('CREATE TEMPORARY TABLE __temp__profil AS SELECT id, installation_id, nom, description, extension, app_id FROM profil');
        $this->addSql('DROP TABLE profil');
