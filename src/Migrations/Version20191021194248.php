 ...
 */
final class Version20191021194248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__badge AS SELECT id, installation_id, matricule, nom, operateur_createur, date_creation, date_deb_val, date_fin_val, date_deb_val2, date_fin_val2, valide, code1, prenom FROM badge');
        ...
        $this->addSql('INSERT INTO badge (id, installation_id, matricule, nom, operateur_createur, date_creation, date_deb_val, date_fin_val, date_deb_val2, date_fin_val2, valide, code1, prenom) SELECT id, installation_id, matricule, nom, operateur_createur, date_creation, date_deb_val, date_fin_val, date_deb_val2, date_fin_val2, valide, code1, prenom FROM __temp__badge');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__glecteur AS SELECT id, installation_id, nom, description, extention FROM glecteur');
        ...
        $this->addSql('INSERT INTO glecteur (id, installation_id, nom, description, extention) SELECT id, installation_id, nom, description, extention FROM __temp__glecteur');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__profil AS SELECT id, installation_id, nom, description, extension FROM profil');
        ...
        $this->addSql('INSERT INTO profil (id, installation_id, nom, description, extension) SELECT id, installation_id, nom, description, extension FROM __temp__profil');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__variable AS SELECT id, installation_id, nom, description, extension, translated_ph FROM variable');
        ...
        $this->addSql('INSERT INTO variable (id, installation_id, nom, description, extension, translated_ph) SELECT id, installation_id, nom, description, extension, translated_ph FROM __temp__variable');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__glecteur AS SELECT id, installation_id, nom, description, extention FROM glecteur');
        $this->addSql('DROP TABLE glecteur');
        $this->addSql('CREATE TABLE glecteur (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, installation_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, extention INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO glecteur (id, installation_id, nom, description, extention) SELECT id, installation_id, nom, description, extention FROM __temp__glecteur');
        $this->addSql('DROP TABLE __temp__glecteur');
        $this->addSql('CREATE INDEX IDX_33B3608D167B88B4 ON glecteur (installation_id)');
        $this->addSql('DROP INDEX IDX_360FA570B839C441');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__profil AS SELECT id, installation_id, nom, description, extension FROM profil');
        $this->addSql('DROP TABLE profil');
        $this->addSql('CREATE TABLE profil (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, installation_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, extension VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO profil (id, installation_id, nom, description, extension) SELECT id, installation_id, nom, description, extension FROM __temp__profil');
        $this->addSql('DROP TABLE __temp__profil');
        $this->addSql('CREATE INDEX IDX_E6D6B297167B88B4 ON profil (installation_id)');
        $this->addSql('DROP INDEX IDX_25787E1B275ED078');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__variable AS SELECT id, installation_id, nom, description, extension, translated_ph FROM variable');
        $this->addSql('DROP TABLE variable');
        $this->addSql('CREATE TABLE variable (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, installation_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, extension VARCHAR(1000) DEFAULT NULL, translated_ph VARCHAR(1000) DEFAULT NULL)');
        $this->addSql('INSERT INTO variable (id, installation_id, nom, description, extension, translated_ph) SELECT id, installation_id, nom, description, extension, translated_ph FROM __temp__variable');
        $this->addSql('DROP TABLE __temp__variable');
        $this->addSql('CREATE INDEX IDX_CC4D878D167B88B4 ON variable (installation_id)');
    }
